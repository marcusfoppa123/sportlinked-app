...
import { Upload, X, Image, Video, BarChart, Plus } from "lucide-react";
...
const UploadButton = ({ className }: UploadButtonProps) => {
  ...
  return (
    <>
      <Button
        ...
        className={`fixed right-4 bottom-20 rounded-full w-14 h-14 shadow-lg bg-athlete hover:bg-athlete/90 z-40 ${className}`}
      >
